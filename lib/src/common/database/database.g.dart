...
abstract class _$MenuDb extends GeneratedDatabase {
  ...
  List<DatabaseSchemaEntity> get allSchemaEntities =>
      [menuCategories, menuItems, menuItemPrices, locations];
}
...
class $$LocationsTableFilterComposer
    extends Composer<_$MenuDb, $LocationsTable> {
...
class $$LocationsTableTableManager extends RootTableManager<
    ...
    (Location, BaseReferences<_$MenuDb, $LocationsTable, Location>),
    Location,
    PrefetchHooks Function()> {
  $$LocationsTableTableManager(_$MenuDb db, $LocationsTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
